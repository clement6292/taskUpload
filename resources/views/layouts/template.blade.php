                    ...
                    @if (Auth::check())
                        <div class="inline-flex items-center">
                            ...
                            <a href="{{ route('logout') }}"
                                ...
                                class="inline-flex items-center border border-t-red-600 text-red-600 hover:text-indigo-800 transition duration-100 ml-12 logout">
                                ...
                                <span class="text-blue-700 mr-4"> {{ Auth::user()->name }}</span>
                            </a>
                        </div>
                    @else
                        <a href="{{ route('login') }}"
